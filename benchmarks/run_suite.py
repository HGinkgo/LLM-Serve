...
AGGREGATE_METRICS = (
    ...
    ("metrics.cuda_graph.captured_graphs", 1.0, "graphs"),
    ("metrics.cuda_graph.replays", 1.0, "replays"),
    ("metrics.pd.prefill_timing.roundtrip_ms", 1.0, "ms"),
    ("metrics.pd.prefill_timing.admit_ms", 1.0, "ms"),
    ("metrics.pd.prefill_timing.handoff_path_ms", 1.0, "ms"),
    ("metrics.pd.prefill_timing.worker_ms", 1.0, "ms"),
    ("metrics.pd.prefill_timing.model_forward_ms", 1.0, "ms"),
    ("metrics.pd.prefill_timing.kv_export_copy_ms", 1.0, "ms"),
    ("metrics.pd.prefill_timing.parent_overhead_ms", 1.0, "ms"),
    ("metrics.pd.prefill_timing.prefill_command_queue_ms", 1.0, "ms"),
    ("metrics.pd.prefill_timing.prefill_response_queue_ms", 1.0, "ms"),
    ("metrics.pd.prefill_timing.decode_command_queue_ms", 1.0, "ms"),
    ("metrics.pd.prefill_timing.decode_worker_admit_ms", 1.0, "ms"),
    ("metrics.pd.prefill_timing.decode_response_queue_ms", 1.0, "ms"),
    ("metrics.pd.prefill_timing.forward_calls", 1.0, "calls"),
